...
class Player
  ...
  def initialize()
    ...
    @abilities[0] = Ability.from_weapon(:title => 'Dagger', :desc => 'A description would go here', :dam_min => 8, :dam_max => 10, :fire_dam => 0, :armor_pierce => 0)
    @abilities[1] = Ability.from_weapon(:title => 'Flamelance', :desc => 'A description would go here', :dam_min => 2, :dam_max => 3, :fire_dam => 2, :armor_pierce => 0)
